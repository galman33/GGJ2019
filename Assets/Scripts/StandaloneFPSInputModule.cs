...
{
  [AddComponentMenu("Event/Standalone FPS Input Module")]
  /// <summary>
  ...
  /// </remarks>
  public class StandaloneFPSInputModule : PointerFPSInputModule
  {
    ...
    protected StandaloneFPSInputModule()
    {
    }
    ...
    public override void UpdateModule()
    {
      ...
      m_MousePosition = GetScreenCenter();
    }
    ...
    public override void ActivateModule()
    {
      ...
      base.ActivateModule();
      m_MousePosition = GetScreenCenter();
      m_LastMousePosition = GetScreenCenter();
    ...
    protected void ProcessMouseEvent(int id)
    {
      ...
      leftButtonData.buttonData.position = GetScreenCenter();
